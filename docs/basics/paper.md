...
[plugins section](../plugins/). Plugins often have a significant impact on the
functionality of Psiagram, and can be used to add sophisticated functionality to
a diagram.
...
- **nodeComponentMap** - `INodeComponentMap`: Object to map component strings to
  an
...
- **edgeComponentMap** - `IEdgeComponentMap`: Object to map component strings to
  an
...
to render into your DOM. Here's an example of how to mount your paper.
...
this method. This is also used internally by Paper for every initial Node
provided. For more details on input Nodes, see the [Node section](node.md).
...
Add an Edge to the Paper. Like addNode, this allows you to add Edges at any
point after Paper has been initialized. This is also used internally within
Paper for adding any initial Edges. For more information on input Edges, see the
