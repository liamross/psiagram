 ...
 */
export const setElementType = (element: Element, elementType: ElementType): void => {
 ...
 * ElementType.
 */
export const hasElementType = (element: Element | null = null, elementType: ElementType): boolean => {
 ...
 */
export const getElementType = (element: Element | null = null): ElementType | string => {
	return element ? (element.getAttribute(ELEMENT_TYPE_DATA_ATTRIBUTE) as ElementType) : '';
};
